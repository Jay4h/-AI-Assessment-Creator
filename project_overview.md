we need to create an ai assessment creator tool . 
 
the architecture should follow this points : Monorepo architechture , SEO optimization ,Server side render
No use of use effect,
avoid  generic react hooks , render.md style/json style mapping for text rendering.
...
Figma : [Figma Designs for AI Assessment Creator](https://www.figma.com/design/voWYBzUZg018Iy258LQT5H/Untitled?node-id=0-1&t=P13EsafZLoMArqWb-1)
